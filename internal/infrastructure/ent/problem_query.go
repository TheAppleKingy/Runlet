...
func (_q *ProblemQuery) QueryCourse() *CourseQuery {
...
func (_q *ProblemQuery) WithCourse(opts ...func(*CourseQuery)) *ProblemQuery {
	query := (&CourseClient{config: _q.config}).Query()
...
func (_q *ProblemQuery) loadCourse(ctx context.Context, query *CourseQuery, nodes []*Problem, init func(*Problem), assign func(*Problem, *Course)) error {
...
func (_q *ProblemQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withCourse != nil {
			_spec.Node.AddColumnOnce(problem.FieldCourseID)
		}
	}
