...
type CourseRepositoryInterface interface {
	...
	GetAllStudentCourses(ctx context.Context, studentId int) ([]*ent.Course, error)
	CreateCourse(ctx context.Context, title string, description string, classesIds []int, teachersIds []int) (*ent.Course, error)
